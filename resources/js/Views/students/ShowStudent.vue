<template>
    ...
    <form @submit.prevent="updateStudent">
        <div class="mb-4">
            ...
            <input type="text" v-model="students.name" disabled
        ...
        <div class="mb-4">
            ...
            <select v-model="students.gender" disabled
        ...
        <div class="mb-4">
            ...
            <input type="text" v-model="students.address" disabled
        ...
        <div>
            <button type="submit" class="bg-gray-500 text-gray-100 px-4 py-2 rounded-lg hover:bg-gray-600">
